...
// Include the file descriptor set generated by build.rs
const FILE_DESCRIPTOR_SET: &[u8] = include_bytes!("sequence_descriptor.bin");
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                if should_play {
                    ...
                    // Print step header
                    println!("🎵 Step {} of {}:", current_step, sequence_data.sequence_length);
                    
                    // Find and print all trigs for this step
                    let step_trigs: Vec<&Trig> = sequence_data.trigs
                        .iter()
